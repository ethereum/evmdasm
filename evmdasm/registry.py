...
INSTRUCTIONS = [
    ...
    Instruction(opcode=0x92, name='SWAP3', category="stack", gas=3, pops=4, pushes=4, description="Exchange 1st and 4th stack items."),
    Instruction(opcode=0x93, name='SWAP4', category="stack", gas=3, pops=5, pushes=5, description="Exchange 1st and 5th stack items."),
    Instruction(opcode=0x94, name='SWAP5', category="stack", gas=3, pops=6, pushes=6, description="Exchange 1st and 6th stack items."),
    Instruction(opcode=0x95, name='SWAP6', category="stack", gas=3, pops=7, pushes=7, description="Exchange 1st and 7th stack items."),
    Instruction(opcode=0x96, name='SWAP7', category="stack", gas=3, pops=8, pushes=8, description="Exchange 1st and 8th stack items."),
